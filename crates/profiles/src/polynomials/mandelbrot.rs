...
impl DynamicalFamily for Mandelbrot
{
    ...
    fn early_bailout(&self, _start: Cplx, c: &Self::Param) -> Option<PointInfo<Cplx>>
    {
        // Main cardioid
        let four_c = 4. * c;
        ...
        if a < y2 {
            ...
            return Some(PointInfo::PeriodicKnownPotential(PointInfoKnownPotential {
                period: 1,
                multiplier,
                potential,
            }));
...
impl MarkedPoints for Mandelbrot
{
    ...
    fn precycles_child(&self, c: &Cplx, orbit_schema: OrbitSchema) -> ComplexVec
    {
        ...
        match (orbit_schema.preperiod, orbit_schema.period) {
            ...
            (2, 4) => Self::precycles_2_4(c),
            (3, 3) => Self::precycles_3_3(c),
            (3, 4) => Self::precycles_3_4(c),
            _ => vec![],
        }
    }
}
...
impl Mandelbrot
{
    ...
    fn precycles_3_4(c: &Cplx) -> ComplexVec
    {
        use dynamo_common::math_utils::polynomial_roots::solve_polynomial;
        let c2 = c * c;
        let coeffs = [
            horner!(
                c, 1., 0., 0., 0., 4., 14., 30., 56., 102., 192., 356., 626., 1015., 1494., 1982.,
                2336., 2415., 2166., 1658., 1062., 555., 226., 66., 12., 1.
            ),
            c2 * horner!(
                c, -4., -4., 8., 44., 112., 232., 504., 1150., 2536., 5096., 9096., 14412., 19984.,
                23952., 24624., 21390., 15408., 9000., 4080., 1320., 264., 24.
            ),
            c * horner!(
                c, -2., -2., -4., 30., 128., 312., 660., 1655., 4452., 11176., 24444., 46830.,
                77336., 108_528., 129_000., 128_151., 104_472., 68580., 34800., 12540., 2772.,
                276.
            ),
            c2 * horner!(
                c, -8., 0., 72., 292., 600., 1432., 4400., 13940., 37944., 89384., 178_704.,
                297_192., 412_560., 472_944., 439_488., 326_160., 186_360., 75240., 18480., 2024.
            ),
            c * horner!(
                c, -2., -10., 18., 193., 454., 926., 2748., 10765., 37230., 110_466., 273_796.,
                548_058., 899_220., 1_202_340., 1_284_192., 1_084_500., 702_270., 319_770., 87780.,
                10626.
            ),
            c * horner!(
                c, -6., 0., 72., 272., 520., 1296., 5264., 23520., 91272., 291_392., 717_360.,
                1_411_536., 2_230_200., 2_764_944., 2_676_240., 1_977_984., 1_023_264., 316_008.,
                42504.
            ),
            horner!(
                c, -1., 0., 12., 120., 236., 664., 1688., 9072., 49356., 218_368., 683_424.,
                1_642_872., 3_117_492., 4_540_536., 5_077_800., 4_316_640., 2_558_160., 895_356.,
                134_596.
            ),
            c2 * horner!(
                c, 32., 64., 384., 512., 1632., 15168., 112_992., 476_856., 1_436_160., 3_342_624.,
                5_806_944., 7_572_240., 7_466_400., 5_116_320., 2_046_528., 346_104.
            ),
            c * horner!(
                c,
                4.,
            ...
            horner!(
                c, 1., 0., -16., -344., -672., 1260., 75180., 563_472., 2_014_740., 4_839_900.,
                8_314_020., 7_759_752., 2_704_156.
            ),
            c2 * horner!(
                c, 0., -56., -168., -1680., 9912., 162_288., 791_280., 2_350_080., 5_116_320.,
                5_969_040., 2_496_144.
            ),
            c * horner!(
                c, -4., -12., -600., -540., 33192., 243_000., 905_760., 2_558_160., 3_837_240.,
                1_961_256.
            ),
            c2 * horner!(
            ...
            c * horner!(
                c, -6., -138., 270., 9675., 62730., 319_770., 895_356., 735_471.
            ),
    ...
    fn precycles_3_3(c: &Cplx) -> ComplexVec
    {
        use dynamo_common::math_utils::polynomial_roots::solve_polynomial;
        let coeffs = [
    ...
    fn precycles_2_4(c: &Cplx) -> ComplexVec
    {
        use dynamo_common::math_utils::polynomial_roots::solve_polynomial;
        let coeffs = [
    ...
    fn cycles_6(c: &Cplx) -> ComplexVec
    {
        use dynamo_common::math_utils::polynomial_roots::solve_polynomial;
        let c2 = c * c;
        let coeffs = [
            horner_monic!(
                c, 1., -1., 1., 3., 7., 17., 35., 76., 155., 298., 536., 927., 1525., 2331., 3310.,
                4346., 5258., 5843., 5892., 5313., 4219., 2892., 1672., 792., 293., 78., 13.
            ),
            -horner_monic!(
                c, 1., -2., -1., -2., -1., -8., -16., -18., -26., -32., -31., 16., 149., 384.,
                730., 1164., 1635., 2032., 2201., 2050., 1614., 1052., 554., 226., 66., 12.
            ),
            c * horner!(
                c, -1., 1., 2., 20., 38., 118., 336., 830., 1789., 3675., 7278., 13177., 21870.,
                33146., 45768., 57763., 65879., 66831., 59408., 45336., 29012., 15146., 6156.,
                1793., 325., 27.
            ),
            horner!(
                c, 1., 0., 4., -4., 8., 50., 62., 112., 181., 342., 426., 12., -1202., -3608.,
                -7396., -12632., -18711., -23728., -25494., -22864., -16778., -9862., -4466.,
                -1440., -287., -26.
            ),
            horner!(
                c, -1., 2., -3., 26., 33., 84., 364., 1166., 2932., 6726., 15798., 33828., 65816.,
                115_718., 182_688., 262_556., 340_280., 390_387., 390_678., 333_800., 237_612.,
                137_324., 61590., 19710., 3900., 351.
            ),
            c * horner!(
                c, 2., -2., -10., 62., 90., 190., 296., 764., 1772., 1900., -148., -6726., -19956.,
                -42692., -77016., -116_249., -145_938., -150_666., -125_470., -82824., -41866.,
                -14982., -3288., -325.
            ),
            horner!(
                c, 1., -4., 14., 28., 6., 202., 966., 3128., 7588., 20584., 52104., 119_292.,
                245_646., 444_356., 728_148., 1_077_208., 1_405_041., 1_592_556., 1_533_190.,
                1_220_740., 784_784., 390_258., 137_862., 29900., 2925.
            ),
            c * horner!(
                c, 2., -14., 36., 80., 212., 328., 672., 3104., 5500., 5416., -3512., -28760.,
                -81704., -185_472., -340_960., -508_344., -612_114., -584_050., -435_980.,
                -247_500., -98868., -24012., -2600.
            ),
            horner!(
                c, -1., 3., 21., -17., 63., 463., 2390., 6152., 18021., 53705., 144_586., 354_856.,
                738_994., 1_379_504., 2_338_720., 3_486_132., 4_503_660., 4_920_750., 4_409_715.,
                3_170_035., 1_756_986., 688_666., 164_450., 17550.
            ),
            horner!(
                c,
                1.,
    ...
    fn cycles_5(c: &Cplx) -> ComplexVec
    {
        ...
        let coeffs = [
            ...
            v,
            horner!(
                c, 1., 3., 9., 28., 66., 137., 265., 436., 642., 794., 766., 576., 316., 105., 15.
            ),
            horner!(
                c, 1., 4., 14., 40., 93., 196., 342., 528., 678., 672., 516., 288., 97., 14.
            ),
            horner!(
                c, 1., 5., 20., 67., 179., 437., 876., 1572., 2398., 2790., 2496., 1629., 637.,
                105.
            ),
            horner!(
                c, 1., 6., 27., 86., 241., 534., 1044., 1720., 2118., 1980., 1341., 540., 91.
            ),
            horner!(
                c, 1., 7., 35., 126., 401., 1000., 2196., 4200., 5990., 6445., 5071., 2366., 455.
            ),
            horner!(
                c, 1., 8., 40., 160., 466., 1152., 2480., 3872., 4465., 3730., 1826., 364.
            ),
            horner!(
                c, 1., 9., 50., 221., 712., 1932., 4712., 8415., 11025., 10615., 6006., 1365.
            ),
            horner!(
                c, 1., 10., 61., 246., 780., 2232., 4543., 6560., 6885., 4180., 1001.
            ),
            horner!(
                c, 1., 11., 73., 324., 1116., 3527., 8113., 13140., 15741., 11011., 3003.
            ),
            horner!(
                c, 1., 12., 78., 336., 1295., 3570., 6580., 8856., 6831., 2002.
            ),
            horner!(
                c, 1., 13., 92., 427., 1779., 5467., 11172., 16962., 15015., 5005.
            ),
