...
impl CubicPer1_0
{
    ...
    fn cycles_child_4(c: &Cplx) -> Vec<Cplx>
    {
        let c2 = c.powi(2);
        let c3 = c2 * c;
        let coeffs = [
            ...
            c2 * horner!(
                c2, 66., 120., 6931., 17479., 27258., 57200., 24298., 19167., 4741., 347., 21.
            ),
            c * horner!(
                c2, 12., 10., 2816., 14873., 22935., 77220., 51440., 41167., 20703., 2143., 322.
            ),
            horner!(
                c2, 1., 0., 776., 9858., 16390., 81510., 89870., 70349., 62943., 10587., 2355.,
                63., 1.
            ),
            c3 * horner!(
            ...
            c3 * horner!(
                c2, 454., 3193., 20800., 132_014., 146_575., 328_173., 284_479., 103_458., 38124.,
                2380., 136.
            ),
            c2 * horner!(
            ...
            c2 * horner!(
                c2, 105., 280., 23206., 107_029., 223_938., 877_305., 764_400., 652_128., 282_222.,
                35735., 4347., 56.
            ),
            c * horner!(
