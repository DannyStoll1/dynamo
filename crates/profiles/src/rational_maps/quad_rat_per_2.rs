...
const DYNATOMIC_PERIOD_4_SHIFT: Cplx =
    Cplx::new(0.006_285_758_096_917_293, 0.695_462_186_936_383_7);
...
{
    let transformed =
        (t * DYNATOMIC_PERIOD_4_ANGLE + DYNATOMIC_PERIOD_4_SHIFT).inv() + DYNATOMIC_PERIOD_4_POLE;
...
fn cycles_6(c: Cplx) -> Vec<Cplx>
{
    let coeffs = [
        horner_monic!(
            c, 1., -19., 162., -822., 2781., -6677., 11858., -16093., 17187., -14858., 10683.,
            -6549., 3486., -1617., 645., -213., 55., -10.
        ),
        -horner!(
            c, 1., -19., 158., -764., 2409., -5279., 8409., -10129., 9582., -7340., 4625., -2411.,
            1041., -363., 99., -19., 2.
        ),
        horner!(
            c, -27., 485., -3900., 18618., -59129., 132_998., -220_866., 279_744., -278_190.,
            223_353., -148_696., 83944., -40647., 16764., -5708., 1512., -280., 28.
        ),
        -horner!(
            c, -27., 483., -3768., 17042., -50158., 102_498., -152_240., 170_888., -150_093.,
            105_861., -60722., 28380., -10696., 3144., -672., 88., -4.
        ),
        horner!(
            c,
            337.,
        ...
        horner!(
            c, 10866., 53830., -332_366., 330_178., 464_512., -876_588., 402_536., 30828., 120.
        ),
        -horner!(
            c, -52906., 402_450., -916_814., 630_094., 271_396., -499_108., 153_604., 5372., 16.
        ),
        horner!(
            c,
            -129_360.,
...
impl MarkedPoints for QuadRatPer2
{
    ...
    #[expect(
        ...
        reason = "the explicit period-2 arm documents that period 2 yields no cycles, alongside the other listed periods"
    )]
